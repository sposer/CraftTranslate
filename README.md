...
- 弹窗定位到鼠标附近，显示原文和译文。
- 内置本地演示 Provider，方便先验证划词链路。
- 支持百度通用文本翻译和 OpenAI 兼容 `/chat/completions` API。
...
1. 启动后打开设置页。
2. 先保持“本地演示”Provider，选中文字并按热键验证弹窗。
3. 需要真实翻译时，切到“百度通用文本翻译”，填写 APP ID 和密钥；或切到“OpenAI 兼容接口”，填写接口地址、API Key 和模型。
